...
import com.aj.service.MakeMyTripService;
...
public class MakeMyTripController {
    ...
    public String bookTicket(@ModelAttribute("passenger") Passenger passenger, Model model) {
        ...
        model.addAttribute("msg", "Your ticket booked with Id : " + ticket.getTicketNum() + " successfully");
        return "index";
    }
    ...
    public String getTicket(@RequestParam Integer ticketNum, Model model) {
        Ticket ticketByNum = service.getTicketByNumI(ticketNum);
